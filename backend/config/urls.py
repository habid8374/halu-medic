...
router.register(r'consultas/medicamentos', MedicamentoConsultaViewSet, basename='consulta-medicamento')
...
router.register(r'liquidacion/cirugias',             LiquidacionCirugiaViewSet,        basename='liquidacion-cirugia')
