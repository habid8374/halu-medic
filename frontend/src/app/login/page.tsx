...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* ═══════════════════════════════════════════════════
          MÓVIL: video arriba + formulario abajo
      ═══════════════════════════════════════════════════ */}

      {/* Video — solo móvil, proporción natural 16:9 */}
      <div className="lg:hidden w-full relative bg-black flex-shrink-0">
        <video
        ...
        <div className="absolute bottom-4 left-0 right-0 flex items-center justify-center gap-2">
          ...
          <img src="/logo-icon.png" alt="" className="h-8 w-8 object-contain drop-shadow-lg" />
          <span className="text-2xl font-black" style={{ fontFamily: "'Nunito', sans-serif", textShadow: '0 2px 12px rgba(0,0,0,0.9)' }}>
            <span className="text-white">Halu</span><span style={{ color: '#5eead4' }}>Medic</span>
          </span>
        </div>
      </div>

      {/* Formulario móvil — debajo del video, fondo blanco con borde redondeado arriba */}
      <div className="lg:hidden flex-1 bg-white rounded-t-3xl -mt-5 relative z-10 px-6 pt-8 pb-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full py-2.5 px-4 bg-halu-600 hover:bg-halu-700 disabled:bg-halu-400
                text-white font-medium rounded-xl text-sm transition-all mt-2
      ...
      {/* ═══════════════════════════════════════════════════
          DESKTOP: panel izquierdo (video) + panel derecho (form)
      ═══════════════════════════════════════════════════ */}
